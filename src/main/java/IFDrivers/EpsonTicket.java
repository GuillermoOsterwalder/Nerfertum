...
public class EpsonTicket
{
 ...
 /**
  * Consulta de estado
  * @param	byVar1	Código de operación {NPCADS}
  ...
  * @param	dblVar3	Monto del ítem (nnnnnnn.nn)
  ...
  * @param	strVar1	Descripción del Item (max 20 bytes)
  * @param	dblVar2	Cantidad (nnnnn.nnn)
  * @param	dblVar3	Monto del ítem (nnnnnnn.nnnn)
  * @param	dblVar4	Tasa del IVA (10.5, 21.0) (nn.nn)
  * @param	byVar5	Calificador de la operación {MmRr}
  * @param	nVar6	Nro de bultos (nnnnn)
  * @param	dblVar7	Tasa de ajuste variable (.nnnnnnnn)
  ...
  * @param	strVar1	Texto con descripción del pago (max 25 bytes)
  * @param	dblVar2	monto (nnnnnnn.nn)
  * @param	byVar3	Calificador del ítem de línea {CTtDR}
  * @return 0 si no hay error y != 0 si hay un error
  */
  ...
  * @param	strVar8	codigo de autorización de la transaccion (max 20 bytes)
  ...
  * @param	byVar19	Si se envia P se deja una línea para la firma del cliente {NP}
  * @param	byVar20	Si se envia P se deja una línea para la aclaración de la firma {NP}
  * @param	byVar21	Si se envia P se deja una línea para el nro de telefono {NP}
  * @return 0 si no hay error y != 0 si hay un error
  */
  ...
  * @param	byVar2	Opción 1 {DPT}
  * @param	byVar3	Opción 2 {SRPQ}
  * @param	byVar4	Opción 3 {OUNS}
  * @param	nVar5	Si el campo 4 es 'U': establece la cantidad de columnas (nn)
  * @param	nVar6	Si el campo 4 es 'U': establece la cantidad de líneas que mide la hoja de papel a usar (nn)
  * @return 0 si no hay error y != 0 si hay un error
  */
  ...
  * @param	nVar1	Tipo de código de Barra a imprimir (nn)
  * @param	strVar2	Datos a Imprimir (max 40 bytes)
  * @param	nVar3	Nro de línea de datos fijos (nnnnn)
  * @return 0 si no hay error y != 0 si hay un error
  */
  ...
  * @param	strVar17	Línea 1 de texto variable (Nro. de Remito en Ticket-Factura o nro. de factura original en Notas de Crédito) (max 40 bytes)
  ...
  * @param	nVar6	Nro de bultos (nnnnn)
  * @param	dblVar7	Tasa de ajuste variable (.nnnnnnnn)
  * @param	strVar8	Linea 1 descripción complementaria del ítem (max 30 bytes)
  * @param	strVar9	Linea 2 descripción complementaria del ítem (max 30 bytes)
  * @param	strVar10	Linea 3 descripción complementaria del ítem (max 30 bytes)
  ...
  * @param	byVar2	Indica si es una percepción sobre el IVA u otra percepción {OIT}
