 ...
 */
public class ProviderDialogPane extends GridView {
    private Label title;
    private Button cancel;
    private Button save;

    public ProviderDialogPane(){
        super(12,17);
        this.getStylesheets().remove(ComponentStyleElements.DEFAULT_STYLESHEET.getPath());
        this.getStylesheets().add(ComponentStyleElements.PROVIDERDIALOG_STYLESHEET.getPath());
        this.getStyleClass().add(ComponentStyleElements.PROVIDERDIALOG_CLASS.getPath());
        inicThings();
        inicClientView();
    ...
    private void inicThings() {
        title = new Label("Carga de Proveedores");
    ...
    private void inicClientView(){
        ...
        Label lastnameLabel = new Label("Apellido del proveedor");
        ...
        lastname.setPromptText("Ingrese el apellido del proveedor");
